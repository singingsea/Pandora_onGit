# -*- coding: utf-8 -*-
"""
Created on Sat Oct 26 08:19:43 2019
...
V3 update (2019-10-26):
    1. for OFFAXIS data, if we want use auto reference mode, the viewing elevation must be 90 degree. This version will try to fix the angles in OFFAXIS modes.
...
start_date = '2019-01-13' # use 'yyyy-mm-dd' format, this only used if process_all_files = False  
end_date = '2019-10-20' # use 'yyyy-mm-dd' format, this only used if process_all_files = False
...
sites_list_LSC = {'Downsview': 'EST', 'FortMcKay': 'MST', 'Fort McKay': 'MST', 'StGeorge':'EST', 'Toronto' : 'EST', 'Egbert':'EST','Fairbanks':'America/Anchorage','StonyPlain': 'MST',}
...
#                df_output.iat[i,col_nm_VEA] = 'NaN'
        ...
        if abs(df_output.iat[i,col_nm_VEA] - 90) < 3:
